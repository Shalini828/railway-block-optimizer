...
function LandingPage() {
  ...
  const features = [
    ...
    {
      title: "Emergency Response & Re-Blocking",
      description: "AI-assisted incident assessment, traffic protection and emergency block planning.",
      icon: Siren,
      link: "/emergency",
      color: "text-red-500",
    },
      ...
      <section className="relative flex flex-col items-center justify-center rounded-2xl border border-border bg-card px-6 py-20 text-center shadow-sm">
        ...
        <div className="relative z-10 flex max-w-3xl flex-col items-center">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            ...
            <Button asChild size="lg" variant="outline" className="h-12 px-8 text-base border-destructive/40 text-destructive hover:bg-destructive/10">
              <Link to="/emergency">
                <Siren className="mr-2 h-4 w-4 animate-pulse" /> Emergency Command
              </Link>
            </Button>
          </div>
        </div>
