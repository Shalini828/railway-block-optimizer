...
const NAV = [
  ...
  { to: "/emergency", label: "Emergency Command", icon: Siren },
] as const;
          ...
          <form onSubmit={handleLogin} className="mt-6 space-y-4">
            ...
            <Button
              ...
              onClick={() => {
                setErrorMsg("");
                signIn(selectedRoleId);
                toast.success("Authenticated as " + selectedRoleId);
              }}
              className="w-full border-primary/40 text-primary hover:bg-primary/10 text-xs"
            >
              Demo Instant Access (Bypass Login)
            </Button>

            <div className="pt-2 text-center flex flex-col gap-1">
              <span className="text-[11px] text-muted-foreground font-mono">Demo Password: 12345</span>
