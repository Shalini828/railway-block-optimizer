...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "IR-ABPS Control Dashboard | Railway Block Planning" },
      {
        name: "description",
        content:
          "Live Indian Railways block planning control room: asset availability, corridor status, shadow block savings and urgent risk radar.",
      },
      { property: "og:title", content: "IR-ABPS Control Dashboard" },
      {
        property: "og:description",
        content:
          "AI-powered block planning control room integrating TMS, SMMS, TDMS, COA and BDMS.",
      },
    ],
  }),
  component: Dashboard,
